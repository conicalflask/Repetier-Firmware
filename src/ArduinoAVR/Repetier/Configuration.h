...
//Maximum number of attempts probe the bed and get a mesh that is acceptable.
#define BEDCOMPENSATION_PROBE_MAX_RETRIES 5

//A rough estimate of the maximum expected probe error. (used to increase tollerances for reprobing)
