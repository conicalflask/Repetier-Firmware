...
On a perfect printer, prints using this firmware won't be any different but on an imperfect printer it's the difference between the frustration of popped-off prints, badly smashed beds, scraped first layers with poor finish quality, and a well printed first layer.
